...
// Read-only view over a loaded PcgFile, shaped for the UI's tree-building code to iterate
// the same way it iterates the local cache. Strictly read-only - nothing here, or anywhere
// in Core/Pcg, ever writes back into a .pcg file.
